...
def normalize_topic(topic: str) -> str:
    ...
    topic_str = re.sub(r"^AGE BASED$", "Age", topic_str, flags=re.IGNORECASE)
    topic_str = re.sub(r"TYPE\s*[-–]\s*", "Type - ", topic_str, flags=re.IGNORECASE)
    topic_str = re.sub(r"LEVEL\s*[-–]\s*", "Level - ", topic_str, flags=re.IGNORECASE)
