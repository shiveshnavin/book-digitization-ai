...
def normalize_topic(topic: str) -> str:
    ...
    topic_str = re.sub(r"\bOWS\b", "One Word Substitution", topic_str, flags=re.IGNORECASE)
    topic_str = re.sub(r"\bpara\s*jumble\b|\bparajumble\b", "Para Jumble", topic_str, flags=re.IGNORECASE)
